...
-----------------------
Since Uberspace uses ruby via RVM, "ruby cron setup" can be executed to write necessary environment variables into the crontab file. Then, cronjobs executing rake tasks can be installed as in the following example:
